...
{
    public partial class PrintRepairSummary : System.Web.UI.Page
    {
            ...
            try
            {
                if (!this.IsPostBack)
                {
                    ...
                    if (model != null)
                    {
                        ...
                        #region Repair
                        ReportParameter DateReturnToCustomer;
                        ...
                        ReportParameter EndWarranty;

                        if (model.Repair != null)
                        {
                            DateReturnToCustomer = new ReportParameter("DateReturnToCustomer", DateExtension.DateThaiFormat(model.Repair.dtDateUpdate.Value));
                            ...
                            if (model.Repair.dtEndWarranty.HasValue)
                            {
                                EndWarranty = new ReportParameter("EndWarranty", DateExtension.DateThaiFormat(model.Repair.dtEndWarranty.Value));
                            }
                            else
                            {
                                EndWarranty = new ReportParameter("EndWarranty", "-");
                            }
                        }
                        else
                        {
                            DateReturnToCustomer = new ReportParameter("DateReturnToCustomer", "-");
                            ReferenceNumber = new ReportParameter("ReferenceNumber", "-");
                            DateAdd = new ReportParameter("DateAdd", "-");
                            TimeAdd = new ReportParameter("TimeAdd", "-");
                            Serial = new ReportParameter("Serial", "-");
        ...
        private void runRptViewer()
        {
            ...
            this.ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/") + "//Reports//ReturnProduct.rdlc";
