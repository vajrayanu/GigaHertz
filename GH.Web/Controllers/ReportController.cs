...
namespace GH.Web.Controllers
{
    ...
    public class ReportController : Controller
    {
        ...
        public ActionResult ReportDay()
        {
            ...
            model.Report.Repairs = ReportManager.ReportRepairDay(start,end);
        ...
        public ActionResult ReportDay(ReportDayViewModel model, FormCollection collection)
        {
            ...
            model.Report = new ReportDay();
            model.Report.Repairs = ReportManager.ReportRepairDay(model.DateStart, model.DateEnd);
        ...
        public ActionResult ReportServiceDay()
        {
            ...
            model.Report.Repairs = ReportManager.ReportServiceDay(start,end);
