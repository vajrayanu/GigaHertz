...
using GH.Memberships.Helpers;
using GH.Memberships.Context;
...
namespace CodeFirstMembershipProvider
{
    public class CodeFirstMembershipProvider : MembershipProvider
    {
        ...
        public override MembershipUser CreateUser(string username, string password, string email, string passwordQuestion, string passwordAnswer, bool isApproved, object providerUserKey, out MembershipCreateStatus status)
        {
            ...
            string HashedPassword = password;//Crypto.HashPassword(password);
            ...
            using (DataContext Context = new DataContext())
            {
                ...
                if(status==0){
                    //insert role with "User"
                    if (providerUserKey.ToString()=="true")
                        Roles.AddUserToRole(NewUser.Username, "SuperUser");
                    else
        ...
        public override bool ChangePassword(string username, string oldPassword, string newPassword)
        {
            ...
            using (DataContext Context = new DataContext())
            {
                ...
                String HashedPassword = User.Password;
                Boolean VerificationSucceeded = true;//(HashedPassword != null && Crypto.VerifyHashedPassword(HashedPassword, oldPassword));
                if (VerificationSucceeded)
                {
                    User.PasswordFailuresSinceLastSuccess = 0;
                }
                ...
                String NewHashedPassword = newPassword; //Crypto.HashPassword(newPassword);
